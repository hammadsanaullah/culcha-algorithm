/*
  ...
  - The values [Evening] on the enum `GYM_SESSION` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "GYM_SESSION_new" AS ENUM ('Morning', 'Afternoon');
